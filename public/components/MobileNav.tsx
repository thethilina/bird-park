...
function NavBar() {
  ...
  return (
   ...
   <Link href={"/"}>  <RiGalleryLine  className="dark:text-[#BEC9F4]  transition-transform hover:scale-105 size-6 lg:size-7" /></Link>
      ...
      <Link href={"/Circle"}><RiUserCommunityFill className="dark:text-[#BEC9F4]  transition-transform hover:scale-105 size-6 lg:size-7" /></Link>

...
function NavBar() {
  return (
    ...
    <nav className="sticky z-100 px-5 lg:px-30 py-1   bg-(--color-background) dark:bg-(--background)  border-(--border)  lg:pt-5  w-full top-0 border-b-2   lg:py-3   flex items-center justify-between ">

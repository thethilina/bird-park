...
function ProfileBar() {
  return (
    <div className='space-y-5 py-5 sticky top-18 z-90 w-full bg-(--color-background) dark:bg-(--background)  ) '>

     <div className=" px-5 lg:px-30 py-1   bg-(--color-background) dark:bg-(--background)  )    w-full      flex items-center justify-between ">
    ...
    <div className="  px-5 lg:px-30  bg-(--color-background) dark:bg-(--background)  )   w-full    flex items-center justify-between ">
